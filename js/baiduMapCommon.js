...
window.baiduMapUtil = function(){
    ...
    var pub = {
         ...
         */
        addMarkerClusterer: function(points,markerOptions,event,handler,labels,labelOptions,labelStyle,data) {
            var markers = [];
            var markerClusterer;
            for (var i = 0, len = points.length; i < len; i++) {
                var marker;
            ...
            markerClusterer = new BMapLib.MarkerClusterer(map,
                {
                    ...
                    minClusterSize: 10,
                    styles:[{
                        url:'/onlineTerminal/ticc/common/static/images/map/polymeric_icon.png',  //图标路径
                        size: new BMap.Size(49, 49),  //图标大小
                        textSize: 10,
                        textColor: '#FFF'
                    }]
                }
         ...
         */
        createInfoBox:function (html) {
            return new BMapLib.InfoBox(map,html,{boxStyle:{
                width: "200px",height: "300px"},align: INFOBOX_AT_BOTTOM,offset:new BMap.Size(0, 0),enableAutoPan: true});
        },
        /**
         * gps坐标转百度坐标
